...
contract PackageDB is Authorized {
    ...
    function setPackageOwner(bytes32 nameHash, address newPackageOwner)
        ...
        returns (bool)
    {
        emit PackageOwnerUpdate(
            nameHash,
            _recordedPackages[nameHash].owner,
            newPackageOwner
        );
    ...
    function getNumPackages() public view returns (uint256) {
    ...
    function getPackageNameHash(uint256 idx) public view returns (bytes32) {
    ...
    function getAllPackageIds(uint256 _offset, uint256 limit)
        public
        view
        returns (bytes32[] packageIds, uint256 offset)
    {
        ...
        uint256 totalPackages = getNumPackages(); // Total number of packages in registry
